...
| `get_symbol_body` | Slices the exact implementation body of a symbol from disk. | Exactly one `symbol_name` or current-index `symbol_id`; `file_path` (opt) | `symbol`, `name`, `path` |
