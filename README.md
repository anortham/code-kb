...
Current source builds use julie-extract 3.6.3. QML references retain inline component
...
```text
Tokens Saved, upper bound: ~<saved> (baseline known for <K> of <M> calls; baseline = reading each file an answer names in full)
```
