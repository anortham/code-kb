...
|---------|----------|-----------------|
| `code-kb-v1.1.0-x86_64-unknown-linux-gnu.tar.gz` | Linux x86_64 | _pending_ |
| `code-kb-v1.1.0-aarch64-apple-darwin.tar.gz` | macOS Apple Silicon | _pending_ |
| `code-kb-v1.1.0-x86_64-apple-darwin.tar.gz` | macOS Intel | _pending_ |
| `code-kb-v1.1.0-x86_64-pc-windows-msvc.zip` | Windows x86_64 | _pending_ |
