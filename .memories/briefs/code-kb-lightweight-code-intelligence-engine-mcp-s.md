...
updated: 2026-09-12T22:44:18.259Z
tags:
  - code-kb
  - mcp
  - code-intelligence
...
## Active Roadmap
1. Tier 3 Background File Watcher (`notify` with 150ms debounce and git-storm circuit breaker).
2. Dogfooding and extraction validation on `julie-extractors` codebase (>30,000 LOC).
3. Tier 2 In-Database FTS5 Conceptual Search (BM25 over docstrings and signatures).
4. Harness integration via `.mcp.json`.
